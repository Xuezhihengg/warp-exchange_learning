package org.warpexchange_learning.tradingapi.web;
...
/**
 * 这个Component设置了用户身份验证的Filter
 * 该Filter会对每一个ServletRequest进行基于Authorization Header或基于API Key的验证
 * 如果认证成功，则通过实例化一个UserContext修改当前线程的用户上下文
 */
@Component
